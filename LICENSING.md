...
Because these projects serve different purposes, a single license is not appropriate for the entire ecosystem.
...
* Widely adopted by major open-source ecosystems.
...
while requiring derivative works to remain open under the same license.
...
Whenever appropriate, standards and technical specifications may use Creative Commons Attribution 4.0 (CC BY 4.0).
...
Some datasets are created by the Open Mission community.

Others originate from third parties and retain their original licenses.

Each dataset repository should clearly document:
...
If you are unsure about the license that applies to a repository or contribution, please open a GitHub Discussion before contributing.
